...
_defineProperty(SendEMail, "sendOTPMail", async (userEmail, userName, subject, otp, amount) => {
  //  Creating a Transport
  const emailTransporter = _nodemailer.default.createTransport({
    host: process.env.EMAIL_HOST,
    port: process.env.EMAIL_PORT,
...
_defineProperty(SendEMail, "sendForgotPasswordMail", async (userEmail, userName, subject, otp) => {
  //  Creating a Transport
  const emailTransporter = _nodemailer.default.createTransport({
    host: process.env.EMAIL_HOST,
    port: process.env.EMAIL_PORT,
