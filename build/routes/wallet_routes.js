...
// Deposit money
walletRouter.post("/deposit_money/:userID", _token_validation.default.userTokenValidation, _wallet_controller.default.depositMoney);

// Withdraw money
walletRouter.post("/withdraw_money/:userID", _token_validation.default.userTokenValidation, _wallet_controller.default.withdrawMoney);

// Verify withdraw money
walletRouter.post("/verify_withdraw_money/:userID", _token_validation.default.userTokenValidation, _wallet_controller.default.verifyWithdrawMoney);
